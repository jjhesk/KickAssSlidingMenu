...
public class MaterialPlain extends FrameLayout {
    ...
    public MaterialPlain(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.MaterialPlain);
        normal = a.getDrawable(R.styleable.MaterialPlain_mrlsxm_touch_normal);
        press = a.getDrawable(R.styleable.MaterialPlain_mrlsxm_touch_press);
        a.recycle();
        try {

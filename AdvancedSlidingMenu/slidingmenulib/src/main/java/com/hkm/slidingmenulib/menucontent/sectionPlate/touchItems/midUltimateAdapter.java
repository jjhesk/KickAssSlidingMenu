 ...
 */
public abstract class midUltimateAdapter<T, BINDHOLDER extends UltimateRecyclerviewViewHolder> extends UltimateViewAdapter {
     ...
     */
    public midUltimateAdapter(List<T> list) {
